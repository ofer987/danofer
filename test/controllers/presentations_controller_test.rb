...
class PresentationsControllerTest < ActionController::TestCase
  ...
  test "should create presentation" do
    assert_difference('Presentation.count') do
      post :create, presentation: { filename: @presentation.filename, location: @presentation.location, name: @presentation.name, presented_at: @presentation.presented_at }
    end
  ...
  test "should update presentation" do
    patch :update, id: @presentation, presentation: { filename: @presentation.filename, location: @presentation.location, name: @presentation.name, presented_at: @presentation.presented_at }
    assert_redirected_to presentation_path(assigns(:presentation))
  end
